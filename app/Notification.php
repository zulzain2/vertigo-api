...
class Notification extends Model
{
    ...
    public static function notificationFCM($json_data)
    {
        ...
        $headers = array(
            'Authorization:key=AAAAA5HsCAw:APA91bGX1b5j9YnR3U9WTbVfAfG0l9qX3WZPPzqvAG32T8C7OCggurbsbOey3UvafiygMVefuHxg36UA9L8ouISpZZ7I6FuAQWUFUrun323YDXOSrCZwflHM4LYxR4CpM45KloNcCAdB',
            'Content-Type: application/json'
        );
        $ch = curl_init();
