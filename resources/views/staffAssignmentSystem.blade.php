        ...
        <div class=" timelineScroll">
            ...
            <div class="timelineTask">
                <div style="width:100%;height:3.8%">
                    <img src="{{ url('/img/team2.jpg') }}" alt="refresh" class="img-fluid rounded-circle  userTask">
                    <div class="taskRowName"><b>Josh</b></div>
                </div>
                <div class=" task1 bgColorPink">
                    <div class=" taskHeader">
                        ...
                        <div class=" taskContent">
                            reduce the amount of shutter. Solve long loading time
                        </div>
