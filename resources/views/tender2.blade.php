...
<div class="row" style="padding-bottom:20px;padding-top:20px">
  <div class="col-lg-12">
    <h3><strong>Tender Management System</strong></h3>
  </div>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel" style="font-weight:bold">Tender Management System (TMS) - Tender Detail</h4>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const tmsEvent = events.map(({
      sitevisit_start_date: start, 
      sitevisit_end_date: end, 
      client_name: title,
            id
    }, index)=>({
        start,
