...
<div class="row" style="padding-bottom:20px;padding-top:20px">
  <div class="col-lg-12">
    <h3><strong>Maintenance Schedule System</strong></h3>
  </div>
</div>
  ...
  <div class="col-lg-8">
    <div class="card">
      <div class="card-body">
          ...
          {!! Form::open(['action' => 'DashboardController@searchMSS', 'method' => 'POST','class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
          @csrf
          ...
          <div class="row">
            <div class="col-lg-6">
              <table style="width:100%">
                <tr>
                  <td>
                    <select class="select2 form-control custom-select" style="width: 100%; height:36px;" id="maintenance" name="maintenance">
                      @if (isset($curr_task))
                          <option value="{{$curr_task->id}}">{{$curr_task->name}}</option>
                      @else
  ...
  <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel" style="font-weight:bold">Maintenance Schedule System (MSS) - Schedule Detail</h4>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      eventClick: function({event: {start, end, title, id}, el}) {
            ...
            modalbody.load(`/mss/${id}`, function( response, status, xhr ) {
              if ( status == "error" ) {
