...
class AddColumnUsers03243342342 extends Migration
{
    ...
    public function down()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->dropColumn('id_role' , 32);
            $table->dropColumn('id_position' , 32);
            $table->dropColumn('id_department' , 32);
            $table->dropColumn('id_access_role' , 32);
            $table->dropColumn('id_access_position' , 32);
            $table->dropColumn('last_log_web' , 32);
            $table->dropColumn('last_log_mobile' , 32);
        });
    }
}
